...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin4::uc($char[$i]) ne Elatin4::lc($char[$i]))) {
...
=item * Only Latin4.pm and Elatin4.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin4::lc
  lcfirst     Elatin4::lcfirst
  uc          Elatin4::uc
  ucfirst     Elatin4::ucfirst
  chr         Elatin4::chr
  glob        Elatin4::glob
  ---------------------------------
...
Latin4.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin4.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin4::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin4::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin4 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin4 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin4)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin4.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin4.pm provides bytes::*
