...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin4 software provides)

Latin4 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin4 software provide)
