...
######################################################################
#
# Char::Latin4 - Source code filter to Latin-4 script
#
...
sub Char::Latin4::escape_script {
    ...
    if (/^ use Char::Elatin4(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin4 %s;\n%s", $Char::Elatin4::VERSION, $use_re_eval); # require run-time routines version
...
=head1 SYNOPSIS
  ...
  use Char::Latin4;
  use Char::Latin4 version;         --- require version
