...
10% everything else. But this "text" means US-ASCII text, and popular Latin-4
...
Perl3 or later can treat Latin-4.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Latin4 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Latin-4, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Elatin4.pm.
  ...
  After                    Definition
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
  ${Char::Elatin4::anchor}         qr{\G(?:[\x00-\xFF])*?}
  ...
  ${Char::Elatin4::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Latin-4 designed for combining with
...
Contrasting is Encode module and describing "use Char::Latin4;" on this software,
