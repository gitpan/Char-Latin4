...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin4::function_ord     = 'Char::Latin4::ord'     if /\A ord \z/oxms;
                    $Char::Elatin4::function_ord_    = 'Char::Latin4::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin4::function_reverse = 'Char::Latin4::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin4::function_getc    = 'Char::Latin4::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin4::escape();
...
=head1 Calling 'Char::Elatin4::ignorecase()' (Char::Latin4 software provides)

Char::Latin4 software applies calling 'Char::Elatin4::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin4 software provides)

Char::Latin4 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin4 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin4 software provides)

Char::Latin4 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin4 software and
