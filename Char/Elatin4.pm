...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Elatin4::index($name, '::') == -1) && (Char::Elatin4::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Elatin4::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Elatin4::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Elatin4::split(;$$$);
sub Char::Elatin4::tr($$$$;$);
sub Char::Elatin4::chop(@);
sub Char::Elatin4::index($$;$);
sub Char::Elatin4::rindex($$;$);
sub Char::Elatin4::lcfirst(@);
sub Char::Elatin4::lcfirst_();
sub Char::Elatin4::lc(@);
sub Char::Elatin4::lc_();
sub Char::Elatin4::ucfirst(@);
sub Char::Elatin4::ucfirst_();
sub Char::Elatin4::uc(@);
sub Char::Elatin4::uc_();
sub Char::Elatin4::fc(@);
sub Char::Elatin4::fc_();
sub Char::Elatin4::ignorecase;
sub Char::Elatin4::classic_character_class;
sub Char::Elatin4::capture;
sub Char::Elatin4::chr(;$);
sub Char::Elatin4::chr_();
sub Char::Elatin4::glob($);
sub Char::Elatin4::glob_();

sub Char::Latin4::ord(;$);
sub Char::Latin4::ord_();
sub Char::Latin4::reverse(@);
sub Char::Latin4::getc(;*@);
sub Char::Latin4::length(;$);
sub Char::Latin4::substr($$;$$);
sub Char::Latin4::index($$;$);
sub Char::Latin4::rindex($$;$);
sub Char::Latin4::escape(;$);
...
${Char::Elatin4::dot}         = qr{(?:[^\x0A])};
${Char::Elatin4::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Elatin4::eD}          = qr{(?:[^0-9])};
...
# ${Char::Elatin4::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Elatin4::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Elatin4::eS}          = qr{(?:[^\s])};

${Char::Elatin4::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Elatin4::eH}          = qr{(?:[^\x09\x20])};
${Char::Elatin4::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Elatin4::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Elatin4::eN}          = qr{(?:[^\x0A])};
${Char::Elatin4::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Elatin4::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Elatin4::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Elatin4::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Elatin4::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Elatin4::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Elatin4::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Elatin4::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Elatin4::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin4::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Elatin4::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Elatin4::not_space}   = qr{(?:[^\s\x0B])};
${Char::Elatin4::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Elatin4::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin4::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Elatin4::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Elatin4::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Elatin4::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Elatin4::foo" used only once: possible typo at here.
${Char::Elatin4::dot}         = ${Char::Elatin4::dot};
${Char::Elatin4::dot_s}       = ${Char::Elatin4::dot_s};
${Char::Elatin4::eD}          = ${Char::Elatin4::eD};
${Char::Elatin4::eS}          = ${Char::Elatin4::eS};
${Char::Elatin4::eW}          = ${Char::Elatin4::eW};
${Char::Elatin4::eH}          = ${Char::Elatin4::eH};
${Char::Elatin4::eV}          = ${Char::Elatin4::eV};
${Char::Elatin4::eR}          = ${Char::Elatin4::eR};
${Char::Elatin4::eN}          = ${Char::Elatin4::eN};
${Char::Elatin4::not_alnum}   = ${Char::Elatin4::not_alnum};
${Char::Elatin4::not_alpha}   = ${Char::Elatin4::not_alpha};
${Char::Elatin4::not_ascii}   = ${Char::Elatin4::not_ascii};
${Char::Elatin4::not_blank}   = ${Char::Elatin4::not_blank};
${Char::Elatin4::not_cntrl}   = ${Char::Elatin4::not_cntrl};
${Char::Elatin4::not_digit}   = ${Char::Elatin4::not_digit};
${Char::Elatin4::not_graph}   = ${Char::Elatin4::not_graph};
${Char::Elatin4::not_lower}   = ${Char::Elatin4::not_lower};
${Char::Elatin4::not_lower_i} = ${Char::Elatin4::not_lower_i};
${Char::Elatin4::not_print}   = ${Char::Elatin4::not_print};
${Char::Elatin4::not_punct}   = ${Char::Elatin4::not_punct};
${Char::Elatin4::not_space}   = ${Char::Elatin4::not_space};
${Char::Elatin4::not_upper}   = ${Char::Elatin4::not_upper};
${Char::Elatin4::not_upper_i} = ${Char::Elatin4::not_upper_i};
${Char::Elatin4::not_word}    = ${Char::Elatin4::not_word};
${Char::Elatin4::not_xdigit}  = ${Char::Elatin4::not_xdigit};
${Char::Elatin4::eb}          = ${Char::Elatin4::eb};
${Char::Elatin4::eB}          = ${Char::Elatin4::eB};
...
sub Char::Elatin4::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin4::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin4::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin4::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Elatin4::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin4::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin4::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin4::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Elatin4::uc($char[$i]);
                my $fc = Char::Elatin4::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Elatin4::not_lower_i}',
                '[:^upper:]'  => '${Char::Elatin4::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Elatin4::not_alnum}',
                '[:^alpha:]'  => '${Char::Elatin4::not_alpha}',
                '[:^ascii:]'  => '${Char::Elatin4::not_ascii}',
                '[:^blank:]'  => '${Char::Elatin4::not_blank}',
                '[:^cntrl:]'  => '${Char::Elatin4::not_cntrl}',
                '[:^digit:]'  => '${Char::Elatin4::not_digit}',
                '[:^graph:]'  => '${Char::Elatin4::not_graph}',
                '[:^lower:]'  => '${Char::Elatin4::not_lower}',
                '[:^print:]'  => '${Char::Elatin4::not_print}',
                '[:^punct:]'  => '${Char::Elatin4::not_punct}',
                '[:^space:]'  => '${Char::Elatin4::not_space}',
                '[:^upper:]'  => '${Char::Elatin4::not_upper}',
                '[:^word:]'   => '${Char::Elatin4::not_word}',
                '[:^xdigit:]' => '${Char::Elatin4::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Elatin4::uc($char);
                        my $fc = Char::Elatin4::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Elatin4::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Elatin4::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Elatin4::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Elatin4::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Char::Latin4::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Latin4::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Elatin4::dot_s} \z/oxms) {
...
sub Char::Latin4::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Elatin4::index($_[0], $_[1], CORE::length(Char::Latin4::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Elatin4::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Latin4::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::Latin4::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Elatin4::rindex($_[0], $_[1], CORE::length(Char::Latin4::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Elatin4::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Latin4::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Latin4::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Latin4::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Latin4::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin4::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin4::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin4::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin4::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin4::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin4::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Elatin4::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Elatin4::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Elatin4::glob';
    }
...
# subroutines of package Char::Elatin4
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Latin4::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Latin4::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Latin4::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin4::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Latin4::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin4::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin4::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Latin4::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin4::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin4::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin4::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin4::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin4::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Elatin4::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Elatin4::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Elatin4::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Elatin4::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Elatin4::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Elatin4::PREMATCH()]}
            ...
            $e_string .= q{Char::Elatin4::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Elatin4::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Elatin4::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Elatin4::POSTMATCH()]}
            ...
            $e_string .= q{Char::Elatin4::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Elatin4
        ...
        elsif ($string =~ /\G \b Char::Latin4::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin4::eval \b                                /oxgc) { $e_string .= 'eval Char::Latin4::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Elatin4::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin4::index \b                               /oxgc) { $e_string .= 'Char::Latin4::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Elatin4::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin4::rindex \b                              /oxgc) { $e_string .= 'Char::Latin4::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Elatin4::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin4::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Elatin4::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin4::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Elatin4::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin4::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Elatin4::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Elatin4::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Elatin4::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin4::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Elatin4::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Elatin4::dot_s}';
        }
        else {
            return '${Char::Elatin4::dot}';
        }
    }
    else {
        return Char::Elatin4::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Elatin4::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Elatin4::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Elatin4::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Elatin4::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Elatin4::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Elatin4::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Elatin4::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Elatin4::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Elatin4::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin4::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin4::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin4::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin4::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Elatin4::uc($char[$i]) ne Char::Elatin4::fc($char[$i]))) {
            if (CORE::length(Char::Elatin4::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Elatin4::uc($char[$i])       . Char::Elatin4::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Elatin4::uc($char[$i]) . '|' . Char::Elatin4::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin4::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin4::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin4::ignorecase(Char::Elatin4::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin4::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin4::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin4::ignorecase(Char::Elatin4::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin4::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin4::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin4::ignorecase(Char::Elatin4::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin4::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Latin4::re_t=%s; while($Char::Latin4::re_t =~ %s){%s local $^W=0; local $Char::Latin4::re_r=%s; %s$Char::Latin4::re_t="$`$Char::Latin4::re_r$'"; pos($Char::Latin4::re_t)=length "$`$Char::Latin4::re_r"; } return $Char::Latin4::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Latin4::re_r=CORE::eval $Char::Latin4::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Latin4::re_r=%s; %s"%s$Char::Latin4::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Latin4::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Latin4::re_r=%s; %s%s="$`$Char::Latin4::re_r$'"; pos(%s)=length "$`$Char::Latin4::re_r"; $Char::Latin4::re_n++} return %s$Char::Latin4::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Latin4::re_r=%s; %s%s="%s$Char::Latin4::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Latin4::re_r=%s; %s%s="%s$Char::Latin4::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Latin4::re_r=CORE::eval $Char::Latin4::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin4::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Elatin4::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Elatin4::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
This module has run-time routines for use Char::Latin4 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin4 software and not
...
This Char::Elatin4 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  at all, Char::Elatin4::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Elatin4::split(//,  $word);
  @fields = Char::Elatin4::split(/:/, $line);
  @words  = Char::Elatin4::split(" ", $paragraph);
  @lines  = Char::Elatin4::split(/^/, $buffer);
  ...
  print join(":" => Char::Elatin4::split(/ */, "hi there"));
  ...
  Char::Elatin4::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Elatin4::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Elatin4::split with no arguments does. Thus,
  Char::Elatin4::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Elatin4::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Elatin4::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Elatin4::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Elatin4::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Elatin4::split is join, except that join can only join with the
...
=item Transliteration
  ...
  print Char::Elatin4::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'
...
=item Chop string
  ...
  character chopped. The Char::Elatin4::chop subroutine is used primary to remove the newline
  ...
  since Char::Elatin4::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Elatin4::chop a literal, only a variable. If you Char::Elatin4::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Elatin4::chop(@lines);

  You can Char::Elatin4::chop anything that is an lvalue, including an assignment:

  Char::Elatin4::chop($cwd = `pwd`);
  Char::Elatin4::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Elatin4::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Elatin4::chop returns the character
  ...
  In the most general case, Char::Elatin4::chop can be expressed using substr:

  $last_code = Char::Elatin4::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Elatin4::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Elatin4::chop;
...
=item Index string
  ...
  $byte_pos = Char::Elatin4::index($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin4::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Elatin4::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Elatin4::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin4::rindex($string,$substr);

  This subroutine works just like Char::Elatin4::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Elatin4::index).
  ...
  while (($byte_pos = Char::Latin4::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Elatin4::fc subroutine for case-insensitive comparisons via Char::Latin4
  software.
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Elatin4::ucfirst instead.
...
=item Upper case first character of string
  ...
  $titlecase = Char::Elatin4::ucfirst(substr($word,0,1)) . Char::Elatin4::lc(substr($word,1));
  ...
  $do_not_use = Char::Elatin4::ucfirst(Char::Elatin4::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Elatin4::fc($string);
  $fc = Char::Elatin4::fc_;

  New to Char::Latin4 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Elatin4::fc($a) eq Char::Elatin4::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Latin4 software has always used casefolding semantics for
...
=item Make character
  ...
  that $code in the character set. For example, Char::Elatin4::chr(65) is "A" in either
  ASCII or Latin-4, not Unicode. For the reverse of Char::Elatin4::chr, use Char::Latin4::ord.
...
=item Filename expansion (globbing)
  ...
  The Char::Elatin4::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Elatin4::glob('"*e f*"');
  @spacies = Char::Elatin4::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Elatin4::glob("'*${var}e f*'");
  @spacies = Char::Elatin4::glob(qq("*${var}e f*"));
