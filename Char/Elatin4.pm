...
#
# Latin-4 path globbing from File::DosGlob module
#
...
This module is a run-time routines of the Char/Latin4.pm.
Because the Char/Latin4.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Char::Elatin4::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Elatin4::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Latin-4 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Elatin4::fc function for case-insensitive comparisons via Char::Latin4
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Latin-4 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Latin-4 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Latin4 software, this function returns the full Unicode-like casefold of
  Latin-4 $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Elatin4::glob function grandfathers the use of whitespace to separate multiple
