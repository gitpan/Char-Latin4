...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Elatin4::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Chop string
  ...
  character chopped. The Elatin4::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Elatin4::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Elatin4::fc function for case-insensitive comparisons via Latin4
  software.
...
=item Fold case string
  ...
  New to Latin4 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Elatin4::glob function grandfathers the use of whitespace to separate multiple
