...
=item Make character
  ...
  set. For example, Elatin4::chr(65) is "A" in either ASCII or Latin-4, not Unicode,
  and Elatin4::chr(0x82a0) is a Latin-4 HIRAGANA LETTER A. For the reverse of
  Elatin4::chr, use Latin4::ord.
