...
# eval $var has eval "..."
$var = <<'END';
eval Char::Latin4::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Char::Latin4::escape $var) {
...
$var = <<'END';
eval Char::Latin4::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Latin4::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Char::Latin4::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Char::Latin4::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Char::Latin4::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Latin4::escape $var) {
