...
# eval {...} has eval "..."
if (eval { eval Char::Latin4::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval Char::Latin4::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval Char::Latin4::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval Char::Latin4::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (eval { eval Char::Latin4::escape $var }) {
...
if (eval { eval Char::Latin4::escape }) {
