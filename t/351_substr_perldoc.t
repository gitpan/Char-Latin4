...
my $color  = Char::Latin4::substr $s, 4, 5;   # black
my $middle = Char::Latin4::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Latin4::substr $s, 14;     # climebed the green tree
my $tail   = Char::Latin4::substr $s, -4;     # tree
my $z      = Char::Latin4::substr $s, -4, 2;  # tr
