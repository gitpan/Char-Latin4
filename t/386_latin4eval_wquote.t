...
if (Char::Latin4::eval " Char::Latin4::eval \" if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } \" ") {
...
if (Char::Latin4::eval " Char::Latin4::eval qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } ") {
...
# Char::Latin4::eval "..." has Char::Latin4::eval '...'
if (Char::Latin4::eval " Char::Latin4::eval ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' ") {
...
if (Char::Latin4::eval " Char::Latin4::eval q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } ") {
...
if (Char::Latin4::eval " if ('้ม' =~ /[แ]/i) { return \"1\" } else { return \"0\" } ") {
...
if (Char::Latin4::eval " if ('้ม' =~ /[แ]/i) { return qq{1} } else { return qq{0} } ") {
...
if (Char::Latin4::eval " if ('้ม' =~ /[แ]/i) { return q{1} } else { return q{0} } ") {
...
my $var1 = 1;
my $var0 = 0;
if (Char::Latin4::eval " if ('้ม' =~ /[แ]/i) { return $var1 } else { return $var0 } ") {
